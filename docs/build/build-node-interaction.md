...
- [Selendra-JS RPC](https://js.selendra.org/docs/substrate/rpc)
- [Substrate API Sidecar](https://github.com/paritytech/substrate-api-sidecar)

**Selendra-JS RPC** is a JavaScript library for interacting with the **Substrate RPC API** endpoint,
distributed as `@selendra/api` Node.js package.  
**Substrate API Sidecar** is using the **Selendra-JS RPC** to provide separately runnable REST
services.

## Selendra RPC

The Selendra client exposes HTTP and WS endpoints for RPC connections. The default ports are
...
Some return values may not appear meaningful at first glance. Selendra uses
