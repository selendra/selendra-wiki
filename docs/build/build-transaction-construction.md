...
[Selendra-JS Tools](https://github.com/Selendra-JS/tools) contains a set of command line tools for
...
For example, let's send 0.5 SEL from `121X5bEgTZcGQx5NZjwuTjqqKoiG8B2wEAvrUFjuw24ZGZf2` to
