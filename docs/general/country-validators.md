...
The Country Validators Programme is an initiative by Web3 Foundation and Parity Technologies to use
the funds held by both organizations to nominate validators in the community.

It serves two major purposes:

1. Give validators a structured on-ramp to join the active set of validators on Selendra.
...
nominations at every {{ selendra: era :selendra }}. The backend does
...
[set up a validator](../maintain/maintain-guides-how-to-validate-selendra.md) as well as additional
...
- {{ kusama: Minimum of 10 KSM self-stake :kusama }}{{ polkadot: Minimum of 5_000 SELs self stake :polkadot }}
...
[leaderboard]: https://country-validators.kusama.network/#/leaderboard
