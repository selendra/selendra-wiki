...
It is important to realize that there is no guarantee that SEL you use for proposing or endorsing a
...
done. Therefore, the SEL that was endorsed will be reserved until the proposal is tabled as a
...
example, 1000 SEL to create ten accounts with 100 SEL instead of a single account with 1000 SEL.
...
Now you can click the menu button (the three SELs) and find the option that says "Clear expired
...
undelegation will restart the lock period for the larger SEL amount and the longest conviction
...
1. Delegate 500 SEL with 1x conviction, then change delegation to 1000 SEL with 1x conviction, the
   lock period will reset for 1000 SEL with 1x conviction.

2. Delegate 500 SEL with 3x conviction, then change the delegation to 1000 SEL with 1x conviction,
   the lock period will reset for 1000 SEL with 3x conviction.

3. Delegate 500 SEL with 1x conviction, then change the delegation to 200 SEL with 1x conviction,
   the lock period will reset for 500 SEL with 1x conviction.
