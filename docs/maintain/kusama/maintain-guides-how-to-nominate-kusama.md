...
out the [Polkadot guide](../maintain-guides-how-to-nominate-selendra.md) instead.
...
`NUMBER_OF_TOKENS`: The number of KSM / SEL you would like to stake to the network. **Note**: KSM
