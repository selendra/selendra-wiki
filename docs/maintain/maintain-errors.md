...
metadata is the [Selendra-Portal](https://portal.selendra.org).

## Selendra Portal

Here's how to find out the detailed error description through `Selendra Portal`.
...
The below table is a reference to the errors that exists in Selendra. It is generated from the
runtime's metadata.
