...
- [Selendra testnet guide](../build/build-parachains.md##testing-a-parachains:-selendra-testnet)
- [selendra-launch](https://github.com/selendra/selendra-launch) - a tool to quickly spin up a
  local Selendra testnet based on some parameters like number of parachains, collator setup, etc.
