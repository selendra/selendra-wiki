...
description: An overview of the cryptographic functions used in Selendra.
keywords: [cryptography, hashing, keypair, signing]
slug: ../learn-cryptography
---

This is a high-level overview of the cryptography used in Selendra. It assumes that you have some
...
The hashing algorithm used in Selendra is
...
Selendra uses Schnorrkel/Ristretto x25519 ("sr25519") as its key derivation and signing algorithm.
