...
One way to create the proposal is to use the Selendra-JS Apps
...
Bob has done something great for {{ selendra: Selendra :selendra }}.
...
{{ selendra: Selendra :selendra }}. Charlie tips
{{ polkadot: 10 SEL :polkadot }}{{ kusama: 1 KSM :kusama }}, Dave tips
{{ polkadot: 30 SEL :polkadot }}{{ kusama: 3 KSM :kusama }}, and Eve tips
{{ polkadot: 100 SEL :polkadot }}{{ kusama: 10 KSM :kusama }}.
...
{{ polkadot: 30 SEL :polkadot }}{{ kusama: 3 KSM :kusama }} from the Treasury. In order for Bob to
...
Anyone can create a Bounty proposal using Selendra-JS Apps: Users are able to submit a proposal on
...
To submit a bounty, please visit [Selendra-JS Apps](https://portal.selendra.org) and click on the
