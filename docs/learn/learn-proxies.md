...
proxy for the relationship. {{ selendra: Selendra :selendra }} offers:
...
Proxies require deposits in the native currency (i.e. SEL) to be created. The deposit is
...
in blocks. {{ selendra: Selendra :selendra }} has approximately 6
...
{{ selendra: Selendra :selendra }}, experiment on the Westend testnet.
