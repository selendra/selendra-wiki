...
This document covers the basics of {{ selendra: Selendra :selendra }}
...
behind {{ selendra: Selendra :selendra }} accounts, please see
[the cryptography page](learn-cryptography.md).

## Account Address

An address is the public part of a {{ selendra: Selendra :selendra }}
account. The private part is the key used to access this address. The public and private parts
together make up a {{ selendra: Selendra :selendra }} account. You can
...
{{ selendra: Selendra :selendra }} accounts, anybody can send tokens to
...
{{ selendra: Selendra :selendra }} there are some exceptions of accounts
...
{{ selendra: Selendra :selendra }} visit the
