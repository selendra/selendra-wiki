...
DOT in your account but you cannot stake as validator or transfer SEL away from your account. You
...
Alice: 10 SEL, Bob: 11 SEL, Charlie: 15 SEL, Dave: 20 SEL, Eve: 100 SEL, Frank 1000 SEL, Georgina:
2000 SEL
...
electing set, it will be Frank, Georgina, Eve, Dave, Alice. Even though Alice has only 10 SEL, she
is first in line in Bag3.

Charlie can put himself in front (move up in the bag) using the `voterList.putInFrontOf` extrinsic,
since he has 15 SEL (more than Alice does at 10). Now if nothing changes for the next era, Frank,
...
Alice gets upset, but she cannot move herself up, since Charlie has more SEL than her. Bob _could_
move himself in front of Alice, since he has 11 SEL (> 10), but he still wouldn't get rewards.

Let us consider a hypothetical scenario where Charlie set the staking rewards to be bonded
automatically and Charlie's stash crosses 20 SEL after rewards from several staking eras. As changes
...
the fact that the solution set must fit in a single block, a minimum number of SEL will be required
...
nominators are sorted by amount of SEL staked and those with more SEL are prioritized. This means
that if you are staking with a small amount of SEL, you may not receive rewards. This minimal amount
...
- **comm.**: Total commission kept by the validator (100% means nominators will not receive a
  reward).
- **total stake**: The total amount of SEL tokens staked by all parties.
- **own stake**: The amount of SEL tokens the validator has put up as a stake.
...
It is worth taking into consideration "own stake" of a validator. This refers to the quantity of SEL
...
If you are not nominating with a large number of SELs, you should try to avoid
...
Finally, if you have a very small amount of SELs, you may not be able to have your nomination fit
...
on current validators, you can get a good idea of how many SELs will likely be necessary to have
...
- [Be a Nominator (Selendra)](../maintain/maintain-guides-how-to-nominate-selendra.md) - Guide on
