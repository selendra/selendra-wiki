...
deployed on the Cardamom common good parachain. It implements the most basic kind of NFT - a data
...
Uniques takes a very bare-bones approach on purpose, to keep the Cardamom chain a simple
