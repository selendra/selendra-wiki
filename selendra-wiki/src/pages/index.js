      ...
      <NavItem href={useDocUrl("getting-started")} aosDelay="0">
        <NavItemContent>
          ...
          <p className="mx-auto small text-secondary px-4">
            ...
            >
              Selendra is a sharded protocol that enables blockchain networks to operate together
              seamlessly.
            </Translate>
          </p>
        </NavItemContent>
      ...
      <NavItem href={useDocUrl("build-index")} aosDelay="200">
        <NavItemContent>
          ...
          <p className="mx-auto small text-secondary px-4">
            ...
            >
              Most up-to-date information on the status of the development tools in the Selendra
              ecosystem.
            </Translate>
          </p>
        </NavItemContent>
  ...
  const ImproveWiki = () => (
    <Col lg={6}>
      ...
      <p className="">
        ...
        >
          This wiki was started by and is maintained by Selendra Developer. It is an open-sourced
          project and aims to be the most extensive resource of knowledge on Selendra and the
          Selendra ecosystem.
        </Translate>
      </p>
      <div>
