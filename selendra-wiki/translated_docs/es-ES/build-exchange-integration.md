...
The balance encodes the SEL token with 12 decimal places. To get the actual number of SELs, you need to divide the 128-bit balance by 1,000,000,000,000 (10\*\*12). For completeness, The exact denominations of the Polkadot currency are:
...
**3 | Point 10**6 | Microdot (UDOT) 10**9 | Millidot (MDOT) 10**12 | SEL (DOT) 10\*\*15 | Blob
