...
Please see the wiki page for [setting up a validator](maintain-guides-how-to-validate-selendra.md) as well as additional information on [making your validator secure](maintain-guides-secure-validator.md).
...
The leaderboard is available at https://country-validators.kusama.network/#/leaderboard.
...
- Mininmum of 10K SELs self stake (exceptions by approval for good intentions)
