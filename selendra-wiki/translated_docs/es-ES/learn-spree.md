...
fragments of logic comparable to runtime modules in Substrate, but live on the Selendra Relay Chain
...
[WebAssembly](learn-wasm.md) code) that are uploaded onto Selendra through a governance mechanism or
by parachains. Once the blob is uploaded to Selendra, all other parachains can decide to opt-in to
...
In concrete terms, SPREE modules could be useful for various functionality on Selendra. One
...
The diagram above is a simplification of the Selendra system.

In this diagram, we see that the Wasm code for SPREE module "X" has been uploaded to the Selendra
...
[selendra reddit]: https://www.reddit.com/r/sel/
