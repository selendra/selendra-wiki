...
Root = "./docs"
SelendraUrl = "https://wiki.selendra.org/docs/"

# Frequently occurring false positives
Whitelist = [
    "https://wiki.selendra.org/docs/community/",
]
                ...
                if links != {}:
                    ...
                    for key in links:
                        ...
                        # Current local page reference
                            ...
                            url = SelendraUrl + slug + links[key]
                            test = testLink(url)
                            logger(test, log, shortPath, links, key)
                            ...
                            if "#" in links[key]:
                                ...
                                if os.path.isfile(linkedFile):
                                    ...
                                    if refSlug is not None:
                                        ...
                                        url = SelendraUrl + refSlug + "#" + keyAfterHash
                                        test = testLink(url)
                                        logger(test, log, shortPath, links, key)
                                    else:
